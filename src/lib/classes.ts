...
export const statDefinitions: StatDefinition[] = [
  { key: 'INT',  label: 'INT',  fullName: 'Intelligence', color: '#00d4ff', description: 'Knowledge, analysis, and data processing' },
  { key: 'REF',  label: 'REF',  fullName: 'Reflexes',     color: '#39ff14', description: 'Reaction time, speed, and coordination' },
  { key: 'DEX',  label: 'DEX',  fullName: 'Dexterity',    color: '#ffd700', description: 'Fine motor skills and manual precision' },
  { key: 'TECH', label: 'TECH', fullName: 'Technique',    color: '#ff6b35', description: 'Technical aptitude and repair skills' },
  { key: 'COOL', label: 'COOL', fullName: 'Cool',         color: '#ff00ff', description: 'Composure, nerve, and intimidation' },
  { key: 'WILL', label: 'WILL', fullName: 'Willpower',    color: '#aa66ff', description: 'Mental fortitude and resistance' },
  { key: 'LUCK', label: 'LUCK', fullName: 'Luck',         color: '#ff4444', description: 'Chance and fortunate breaks' },
  { key: 'MOVE', label: 'MOVE', fullName: 'Movement',     color: '#00ff88', description: 'Running speed and agility' },
  { key: 'BODY', label: 'BODY', fullName: 'Body',         color: '#ff4500', description: 'Physical strength and endurance' },
  { key: 'EMP',  label: 'EMP',  fullName: 'Empathy',      color: '#ff69b4', description: 'Social awareness and humanity' },
];
